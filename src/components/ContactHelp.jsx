          ...
          <div className='flex flex-wrap flex-row'>
            <div className='lg:w-1/2' data-aos="fade-right">
              <form ref={form} onSubmit={sendEmail}>
                <input type='' required placeholder='Your Name' name='user_name' className='py-[14px] px-[16px] text-[14px] font-medium leading-[142.857%] text-[#A7A7A7] 
                border border-solid border-[#025066] w-full rounded-[6px] outline-none lg:max-w-[594px] mb-[14px]'/>

                <input type='' required placeholder='Phone Number' name='user_contact' className='py-[14px] px-[16px] text-[14px] font-medium leading-[142.857%] !text-[#A7A7A7] 
                border border-solid border-[#025066] w-full rounded-[6px] outline-none lg:max-w-[594px] mb-[14px]'/>

                <input type='' required placeholder='E-Mail' name='user_email' className='py-[14px] px-[16px] text-[14px] font-medium leading-[142.857%] !text-[#A7A7A7] 
                border border-solid border-[#025066] w-full rounded-[6px] outline-none lg:max-w-[594px] mb-[14px]'/>
                ...
                <button type='submit' className='hover:shadow-[0_3px_20px_rgba(2,80,102,1)] transition-all duration-500 ease-linear mt-[27px] rounded-[10px] bg-[#025066] px-[33px] py-[18px] text-[20px] font-medium text-white uppercase'>CONTACT NOW</button>
              </form>
            </div>
